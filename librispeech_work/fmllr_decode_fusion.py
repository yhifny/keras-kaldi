...
asr = MappedLatticeFasterRecognizer.from_files(
    ...
    acoustic_scale=0.06666666666666666666666666666667, decoder_opts=decoder_opts)
...
path1 = "/media/lumi/alpha/asr_work_cnn_big/model.hdf5" 
path2 = "/media/lumi/alpha/asr_work_cnn_gru/model.hdf5" 
path3 = "/media/lumi/alpha/asr_work_cnn_gru_seq/model.hdf5" 
path4 = "/media/lumi/alpha/asr_work_fcn/model.hdf5" 

models=[]

for  filename in [path1,path2,path3, path4]:
    print (filename)
    kalid_model = load_model(filename, custom_objects={'GatedConvBlock':GatedConvBlock,
                                                        'NovoGrad': NovoGrad, 
...
if sys.argv[2]== 'test_clean': feats_rspecifier = config.fmllr_test_feats_rspecifier
