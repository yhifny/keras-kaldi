...
SCORING_PATH=/home/lumi/Dropbox/ALL/timit_work/score_timit
...
python $GENSCLITE $LOG_DIR/ref48.txt > $LOG_DIR/ref48.txt.sclite  
python $GENSCLITE $LOG_DIR/hyp48.txt > $LOG_DIR/hyp48.txt.sclite
$SCLITE -r $LOG_DIR/ref48.txt.sclite -h $LOG_DIR/hyp48.txt.sclite -i rm -o all  
